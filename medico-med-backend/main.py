...
async def voice_chat(audio: UploadFile = File(...), session_id: str = Form("default"), username: Optional[str] = Form(None)):
    """Handle voice chat"""
    try:
        ...
        # Username is now extracted from form data via function parameter
